...
class Validator:
    ...
    def validate_lazy(self: 'Validator', node: BaseNode, data: typing.Any, force: bool=False) -> dt.ValidationResult:
            """
            ...
            try:
                if not node.forward_ref.__forward_evaluated__:
                    ...
                    evaluated_type = typing._eval_type(node.forward_ref, global_vars, local_vars)
            ...
            actual_type = node.get_actual_data_type(self_validation_result, child_validation_results, valid)
            ...
            reduced_data = node.reduce_data(self, self_validation_result, child_validation_results)
...
def init_validator(settings, hints: typing.Dict, parent: typing.Optional[Validator]=None) -> Validator:
    """
