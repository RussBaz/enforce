...
from enforce.protocol import register, is_registered, retrieve, deregister_all
...
class TestProtocol(unittest.TestCase):
    ...
    def test_simple_protocol_registration(self):
        class A:
            ...
            def foo_1(self, data: int): pass

            def foo_2(self, data: str) -> int: pass
    ...
    @pytest.mark.skipif(sys.version_info < (3, 6), reason='Test for Python 3.6.x+ syntax only')
    def test_parent(self):
        ...
        class A:
            ...
            def bar(self, data: str) -> str: pass
