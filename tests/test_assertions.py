...
class AssertionsTests(unittest.TestCase):
    ...
    def test_basic_assertion_generation(self):
        ...
        assert_complex = get_assert_for(Union[Dict[str, Optional[Union[int, List[int]]]], List[Tuple[str, int]]])
        data1 = [('a', 12), ('b', 123)]
        data2 = {
            'a': 12,
            'b': [12, 123, 3],
    ...
    def test_string_representation(self):
        ...
        definition = Union[Dict[str, Optional[Union[int, List[int]]]], List[Tuple[str, int]]]
